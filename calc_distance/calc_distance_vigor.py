...
import pickle
from cvcities_base.dataset.vigor import VigorDatasetTrain
...
dataset = VigorDatasetTrain(data_folder="D:/Datasets/VIGOR",
                            same_area=SAME_AREA)
...
print("Saving...")  
with open("D:/Datasets/VIGOR/gps_dict_same.pkl", "wb") as f:
...
print("Saving...")  
with open("D:/Datasets/VIGOR/gps_dict_cross.pkl", "wb") as f:
    pickle.dump(near_neighbors, f)   
