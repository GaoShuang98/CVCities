...
class Configuration:
    ...
    gps_dict_path: str = "D:/Datasets/VIGOR/gps_dict_cross.pkl"  # gps_dict_cross.pkl | gps_dict_same.pkl

    # Eval
    batch_size_eval: int = 152
    ...
    # Learning Rate
    lr: float = 0.0015  # 1 * 10^-4 for ViT | 1 * 10^-1 for CNN
