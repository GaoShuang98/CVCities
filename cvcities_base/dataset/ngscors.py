...
class NGSCORSDatasetTrain(Dataset):
    ...
    def __init__(self,
        ...
        self.df = pd.read_csv(f'{data_folder}/splits/train-20zl.csv', header=None)
...
class NGSCORSDatasetEval(Dataset):
    ...
    def __init__(self,
        ...
        if split == 'train':
            ...
            self.df = pd.read_csv(f'{data_folder}/splits/val-20zl.csv', header=None)
...
if __name__ == '__main__':
    data_folder = "E:/datasets/NGSCORS"
    datasets_train = NGSCORSDatasetTrain(data_folder)
    print(datasets_train)
    datasets_eval = NGSCORSDatasetEval(data_folder, split='test', img_type='reference')
    print(datasets_eval)
